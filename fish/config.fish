...
alias dotfiles-save="cd ~/dotfiles && cp ~/.config/waybar/config waybar/ && cp ~/.config/waybar/config-bottom waybar/ && cp ~/.config/waybar/style.css waybar/ && cp ~/.config/waybar/style-bottom.css waybar/ && cp ~/.config/hypr/hyprland.conf hypr/ && git add . && git commit -m \"update: dotfiles\" && git push && cd -"
function waybars
    pkill -x waybar
    sleep 1
